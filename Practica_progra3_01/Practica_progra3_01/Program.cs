...
namespace Practica_progra3_01
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Caballo miCaballo = new Caballo("Vicente");
            Humano miHumano = new Humano("Miguel");
            Gorila miGorila = new Gorila("Elian");
            Ballena miBallena = new Ballena("Rodrigo");
            Cocodrilo miCocodrilo = new Cocodrilo("Palomino");
